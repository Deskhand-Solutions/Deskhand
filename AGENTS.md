...
- **Local Testing Mandatory**: Before pushing any feature branch, the agent **must** run backend and frontend tests locally (`python runtests.py` and `npm test`/`npm run build`) to ensure the remote pipeline remains green.
